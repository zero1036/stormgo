...
public class ReportBolt extends BaseRichBolt {
    ...
    public void execute(Tuple input) {
        ...
        String value = input.contains("merge") ? input.getStringByField("merge") : "?";
        Integer count = input.contains("count") ? input.getIntegerByField("count") : -1;


        System.out.println("merge:" + value + ";count:" + count);
